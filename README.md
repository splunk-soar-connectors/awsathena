...
action_result.data.\*.NamedQuery.QueryString | string | `athena query` | SELECT origin, count(\*) AS total_departures FROM test_table WHERE year >= '2000' GROUP BY origin ORDER BY total_departures DESC LIMIT 10; |
